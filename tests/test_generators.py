...
@pytest.mark.parametrize(
    "description, expected_description_id",
    [
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, 2, ["0000 0000 0000 0001", "0000 0000 0000 0002"]),  # Ожидаемые номера карт от 1 до 2 включительно
