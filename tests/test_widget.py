...
def test_mask_account_card_if_card(input_string: str, expected: str)-> None:
...
def test_mask_account_if_account(input_string: str, expected: str)-> None:
...
def test_account_card_error(input_string: str, message_error: str)-> None:
...
def test_get_date_positive(input_date: str, expected: str)-> None:
...
def test_get_date_negative(input_date: str)-> None:
    with pytest.raises(ValueError):
        get_date(input_date)
