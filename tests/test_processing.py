...
@pytest.mark.parametrize("input_data, decrease, expected", [
    ...
    (
        [{"id": 1, "date": "2023-07-15T14:30:00.000000"}],
        False,
        [{"id": 1, "date": "15.07.2023"}]
    ),

])
def test_sort_by_date(input_data, decrease, expected):
...
def test_sort_by_date_invalid_input(input_data):
